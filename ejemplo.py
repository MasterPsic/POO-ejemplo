...
# En este ejemplo, la clase `Persona` tiene propiedades `nombre` y `edad`, que se pueden acceder y modificar utilizando los métodos `@property` y `@nombre.setter` (o `@edad.setter`).
